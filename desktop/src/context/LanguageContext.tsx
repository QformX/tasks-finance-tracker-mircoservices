...
const translations: Translations = {
  en: {
    ...
    "language_ru": "Russian",
    "theme_label": "Theme",
    "theme_desc": "Choose your preferred appearance",
    "theme_dark": "Dark",
    "theme_light": "Light",
    ...
    "day_view": "Day",
    "all_day": "All-day",
    "no_all_day_tasks": "No all-day tasks",
    ...
    "view_critical": "View Critical",
    "current_streak": "Current Streak",
    "days": "days",
    "streak_keep_burning": "Keep the fire burning! Complete a task daily.",
    "streak_start": "Complete a task today to start a streak!",
    "peak_hour": "Peak Hour",
    "no_data": "No data",
    "peak_hour_desc": "Your most productive time of day based on completions.",
    "burnout_risk": "Burnout Risk",
    "avg_task_time": "Avg. Task Time",
    "burnout_high_load": "High Load",
    "burnout_desc": "You're creating significantly more tasks than you're completing. Take a break!",
    "avg_task_time_desc": "Average time from creation to completion in this period.",
    ...
    "you": "You",
    "thinking": "Thinking...",
    "type_message_placeholder": "Type a message to your assistant...",
    "ai_welcome_message": "Hello {name}! 👋 How can I help you manage your tasks or purchases today?",
  ...
  ru: {
    ...
    "language_ru": "Русский",
    "theme_label": "Тема",
    "theme_desc": "Выберите предпочтительное оформление",
    "theme_dark": "Темная",
    "theme_light": "Светлая",
    ...
    "day_view": "День",
    "all_day": "Весь день",
    "no_all_day_tasks": "Нет задач на весь день",
    "plus_more": "+ еще {count}",
    ...
    "tasks_done": "Завершено",
    "high": "Высокий",
    "medium": "Средний",
    "low": "Низкий",
    "action_needed": "Требует внимания",
    "forecast": "Прогноз",
    "avg_days": "{days}д в ср.",
    "selected_period": "Выбранный период",
    "created": "Создано",
    "spent": "Потрачено",
    "shopping_list_created": "Список покупок (Создано)",
    "view_critical": "Критические задачи",
    "current_streak": "Текущая серия",
    "days": "дн.",
    "streak_keep_burning": "Так держать! Выполняйте задачи каждый день.",
    "streak_start": "Выполните задачу сегодня, чтобы начать серию!",
    "peak_hour": "Пиковый час",
    "no_data": "Нет данных",
    "peak_hour_desc": "Ваше самое продуктивное время на основе выполненных задач.",
    "burnout_risk": "Риск выгорания",
    "avg_task_time": "Ср. время задачи",
    "burnout_high_load": "Высокая нагрузка",
    "burnout_desc": "Вы создаете значительно больше задач, чем выполняете. Сделайте перерыв!",
    "avg_task_time_desc": "Среднее время от создания до завершения за этот период.",
    "activity_direction": "Направление активности",

    // AI Chat
    "ai_agent_chat": "AI Ассистент",
    "start_new_chat": "Новый диалог",
    "you": "Вы",
    "thinking": "Думает...",
    "type_message_placeholder": "Введите сообщение для ассистента...",
    "ai_welcome_message": "Привет, {name}! 👋 Чем я могу помочь тебе с управлением задачами или покупками сегодня?",
