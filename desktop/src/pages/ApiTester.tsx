...
export function ApiTester() {
  ...
  return (
    <div className="p-4 bg-gray-900 text-white min-h-screen flex gap-4 font-mono text-sm">
      ...
      <div className="w-1/2 space-y-6 overflow-y-auto h-screen pb-20 pr-2">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={logout} className="bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-xs">Logout (Client)</button>
          </div>
        </div>
        
        {/* Auth Section */}
        <div className="p-4 border border-gray-700 rounded bg-gray-800/50">
          <h2 className="text-lg font-bold mb-2 text-blue-400">Auth Service</h2>
          <div className="flex flex-wrap gap-2 mb-2">
            <button className="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded" onClick={doMe}>Get Me</button>
            <button className="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded" onClick={doSessions}>Get Sessions</button>
            <button className="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded" onClick={doHealth}>Health Check</button>
          </div>
          <div className="flex flex-wrap gap-2">
            <button className="bg-red-900 hover:bg-red-800 px-3 py-1 rounded" onClick={doLogoutServer}>Logout (Server)</button>
            <button className="bg-red-900 hover:bg-red-800 px-3 py-1 rounded" onClick={doDeleteAccount}>Delete Account</button>
          </div>
        </div>

        {/* Tasks Section */}
        <div className="p-4 border border-gray-700 rounded bg-gray-800/50">
          <h2 className="text-lg font-bold mb-2 text-purple-400">Core: Tasks</h2>
          <div className="flex gap-2 mb-2">
            ...
            />
            <select 
              className="bg-gray-900 border border-gray-600 p-1 rounded w-32"
            ...
            <button className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded" onClick={createTask}>Create</button>
          </div>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            />
            <button className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded" onClick={toggleTask}>Toggle</button>
            <button className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded" onClick={updateTask}>Update</button>
            <button className="bg-red-600 hover:bg-red-700 px-3 py-1 rounded" onClick={deleteTask}>Delete</button>
          </div>
          <div className="flex gap-2">
            <button className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded" onClick={getTasks}>List Tasks (Today)</button>
          </div>
        </div>

        {/* Categories Section */}
        <div className="p-4 border border-gray-700 rounded bg-gray-800/50">
          <h2 className="text-lg font-bold mb-2 text-yellow-400">Core: Categories</h2>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            />
            <select 
              className="bg-gray-900 border border-gray-600 p-1 rounded w-24"
              value={categoryType}
            ...
            <button className="bg-yellow-600 hover:bg-yellow-700 px-3 py-1 rounded" onClick={createCategory}>Create</button>
          </div>
          <div className="flex gap-2">
            <button className="bg-yellow-600 hover:bg-yellow-700 px-3 py-1 rounded" onClick={getCategories}>List Categories</button>
          </div>
        </div>

        {/* Purchases Section */}
        <div className="p-4 border border-gray-700 rounded bg-gray-800/50">
          <h2 className="text-lg font-bold mb-2 text-green-400">Core: Purchases</h2>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            <button className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded" onClick={createPurchase}>Create</button>
          </div>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            />
            <button className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded" onClick={togglePurchase}>Toggle</button>
            <button className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded" onClick={updatePurchase}>Update</button>
            <button className="bg-red-600 hover:bg-red-700 px-3 py-1 rounded" onClick={deletePurchase}>Delete</button>
          </div>
          <div className="flex gap-2">
            <button className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded" onClick={getPurchases}>List Purchases</button>
          </div>
        </div>

        {/* Smart Views Section */}
        <div className="p-4 border border-gray-700 rounded bg-gray-800/50">
          <h2 className="text-lg font-bold mb-2 text-pink-400">Core: Smart Views</h2>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            />
            <button className="bg-pink-600 hover:bg-pink-700 px-3 py-1 rounded" onClick={createSmartView}>Create</button>
          </div>
          <div className="flex gap-2 mb-2">
            <input 
              className="bg-gray-900 border border-gray-600 p-1 rounded flex-1" 
            ...
            />
            <button className="bg-pink-600 hover:bg-pink-700 px-3 py-1 rounded" onClick={getSmartViewItems}>Get Items</button>
          </div>
          <div className="flex gap-2">
            <button className="bg-pink-600 hover:bg-pink-700 px-3 py-1 rounded" onClick={getSmartViews}>List Smart Views</button>
          </div>
        </div>
      ...
      {/* Right Panel: Logs */}
      <div className="w-1/2 bg-black p-4 rounded border border-gray-800 flex flex-col h-screen">
        <div className="flex justify-between items-center mb-2 border-b border-gray-800 pb-2">
          <h2 className="text-xl font-bold text-gray-300">Response Logs</h2>
        ...
        <div className="flex-1 overflow-y-auto font-mono text-xs space-y-2">
          ...
          {logs.map((l, i) => (
            <div key={i} className="border-b border-gray-900 pb-1 whitespace-pre-wrap break-words text-gray-300 hover:bg-gray-900 p-1 rounded transition-colors">
              {l}
            </div>
          ))}
        </div>
